...
void TestingProtocol::prepareUserName(std::string &str){

}

bool TestingProtocol::isValidUsername(const std::string &str){
	// TODO: check valid email address
	return true;
}

std::list<std::string> TestingProtocol::transportFeatures(){
	return m_transportFeatures;
}

std::list<std::string> TestingProtocol::buddyFeatures(){
...
TestingProtocol *TestingProtocol::m_pInstance = NULL;
